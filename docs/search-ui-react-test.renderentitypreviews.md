...
[Home](./index.md) &gt; [@yext/search-ui-react-test](./search-ui-react-test.md) &gt; [RenderEntityPreviews](./search-ui-react-test.renderentitypreviews.md)
...
For the entity previews to be navigable in the search bar's dropdown section, wrap each entity preview in a [DropdownItem()](./search-ui-react-test.dropdownitem.md) component.
