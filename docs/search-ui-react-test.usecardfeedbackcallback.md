...
[Home](./index.md) &gt; [@yext/search-ui-react-test](./search-ui-react-test.md) &gt; [useCardFeedbackCallback](./search-ui-react-test.usecardfeedbackcallback.md)
...
(analyticsType: [FeedbackType](./search-ui-react-test.feedbacktype.md)<!-- -->) =&gt; void
