...
[Home](./index.md) &gt; [anguyen-search-ui-react-test](./anguyen-search-ui-react-test.md) &gt; [StandardFacets](./anguyen-search-ui-react-test.standardfacets.md)

## StandardFacets() function

> Warning: This API is now obsolete.
> 
> Use [Facets()](./anguyen-search-ui-react-test.facets.md) instead.
> 
